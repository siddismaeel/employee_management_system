						...
						<ul class="navbar-nav ms-auto mt-2 mt-lg-0 ">
							...
							<li class="nav-item dropdown text-white"><a
								...
								<div class="dropdown-menu dropdown-menu-end bg-dark"
									...
									<a class="dropdown-item text-white" href="${pageContext.request.contextPath}/employeeProfile.html">Profile</a> <a
									...
									<table class="table">
										...
										<c:forEach var="emp" items="${compliance}">
											<tr>
												...
												<a href="${pageContext.request.contextPath}/editComment.html?empId=${sessionScope.employee.empId}&complianceId=${emp.complianceId}&departmentId=${sessionScope.employee.departmentId}">Add Comments</a>
									...
									<table class="table">
										...
										<c:forEach var="rep" items="${report}">
											<tr>
												...
												<td>${rep.comments}</td>
												<td><a href="${pageContext.request.contextPath}/Comment.html?statusReportId=${rep.statusReportId}">edit</a>
												</td>	
