...
<body>
	<div id="wrapper">
		...
		<ul id="dropdown1" class="dropdown-content">
			<li><a href="profile.html"><i class="fa fa-user fa-fw"></i> My Profile</a>
			</li>
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="Employee.html" class="waves-effect waves-dark"><i
					...
					<div class="col-md-6 col-sm-6">
						<div class="card teal">
							<div class="card-content white-text">
								<span class="card-title">Compilance</span>
								...
								<c:if test="${not empty compliance}">
									<table class="table">
										...
										<c:forEach var="emp" items="${compliance}">
											<tr>
												<td>${emp.rlType}</td>
												<td>${emp.details}</td>
												...
												<c:if test="${emp.status =='OPEN' }">
												
												<a href="${pageContext.request.contextPath}/editComment.html?empId=${sessionScope.employee.empId}&complianceId=${emp.complianceId}&departmentId=${sessionScope.employee.departmentId}" style="color:white">Add Comments</a>
												
												</c:if>	
												<c:if test="${emp.status =='CLOSED' }">
												Closed
												</c:if>
			...
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="card teal">
							<div class="card-content white-text">
								<span class="card-title">Status Report</span>
		...
		<footer>
					<p>
						All right reserved. <a href="#">REALCODERZ</a>
					</p>
				</footer>
		</div>
		<!-- /. PAGE INNER  -->
